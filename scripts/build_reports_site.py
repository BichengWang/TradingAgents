...
DISCLAIMER = (
    "!!! warning \"Disclaimer\"\n"
    "    This website and its AI-generated reports are for **AI testing and "
    "experimentation only**. They do not constitute financial or investment "
    "advice and are not a substitute for a qualified financial adviser. "
    "Reports may contain errors. Do not use them to make investment or "
    "trading decisions."
)
